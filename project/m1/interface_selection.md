I am choosing AXI Stream as my interface, as it meets my requirements in terms of data bandwidth while being less complex to implement than PCIE, which would be the next step up in terms of throughput. 
