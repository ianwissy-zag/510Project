...
VL_ATTR_COLD void Vcrossbar_tb___024root___eval_settle(Vcrossbar_tb___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        ...
        __VstlContinue = 0U;
        if (Vcrossbar_tb___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD bool Vcrossbar_tb___024root___eval_phase__stl(Vcrossbar_tb___024root* vlSelf) {
    ...
    // Body
    Vcrossbar_tb___024root___eval_triggers__stl(vlSelf);
...
VL_ATTR_COLD void Vcrossbar_tb___024root___dump_triggers__nba(Vcrossbar_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcrossbar_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcrossbar_tb___024root___dump_triggers__nba\n"); );
    // Body
