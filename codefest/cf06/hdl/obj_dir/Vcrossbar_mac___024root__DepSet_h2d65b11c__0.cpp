...
VL_INLINE_OPT VlCoroutine Vcrossbar_mac___024root___eval_initial__TOP__Vtiming__0(Vcrossbar_mac___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcrossbar_mac__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcrossbar_mac___024root___eval_initial__TOP__Vtiming__0\n"); );
    // Init
    ...
    VL_PRINTF_MT("-Info: crossbar_tb.sv:27: $dumpvar ignored, as Verilated without --trace\n");
...
void Vcrossbar_mac___024root___eval_triggers__act(Vcrossbar_mac___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcrossbar_mac__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcrossbar_mac___024root___eval_triggers__act\n"); );
    // Body
